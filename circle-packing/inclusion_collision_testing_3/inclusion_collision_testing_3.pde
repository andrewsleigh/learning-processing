...
void draw() {
  ...
  for (int i = 0; i < Circles.length; i++) {
    ...
    if (! doesCollide) {
      ...
      //float red = random(0, map(i,0,Circles.length,0,100));
      //float green = random(map(i,0,Circles.length,100,255), 255);
     // float blue = random(map(i,0,Circles.length,0,155), 255);
      
      //float red = map(random(0,Circles.length), 0, Circles.length, 0, 255 );
      //float green = map(random(0,Circles.length), 0, Circles.length, 0, 255 );
      //float blue = map(random(0,Circles.length), 0, Circles.length, 0, 255 );
